...
$stmt->execute();
$users = $stmt->fetchAll(PDO::FETCH_CLASS, 'Users');

//QUERY FROM STICKER
$stickers = fetchClass($conn, $queryAllStickers, 'Stickers');

$list = ["01", "02", "03", "04", "05", "06", "07", "08", "09", "10", "11", "12"];

//GET STICKER LIST ID
$stickerId = $_GET["sticker"] ?? "1";
$sticker = ($stickerId) ? $stickers[($stickerId - 1)] : $stickers[0];
            ...
            <div class="sidebar">
                <nav class="sidebar__nav" role="navigation">
                    ...
                    <ul class="sidebar__list">
                        ...
                        <!-- HW 驗證登入顯示帳號-->
                        <?php if($account) { ?>
                        <li class="sidebar__list_item userList-li" >註冊清單</li>
                        <li class="sidebar__list_item">
                            <!-- HW 完成列出註冊清單-->
                            <?php foreach ($users  as $user) { ?>
                                <li class="sidebar__list_item userList-li" >
                                    <p>
                                        註冊編號： <?= $user->id ?>
                                    </p>
                                    <p>
                    ...
                    <div class="main__section--sticker-view">
                        <div class="section__endTop">
                            <div class="endTop__graphic">
                                <img class="endTop__graphic_img" width="230" height="230" src="./img/sticker-<?= $sticker->id . '/index' ?>.png">
                                        ...
                                        <?php foreach ($list as $num) { ?>
                                            <li class="sticker__li detailView__stickerList_item">
                                                <div class="sticker__li_inner detailView__stickerList_image">
                                                    <span class="sticker__image detailView__stickerList_customBase" style="background-image:url(./img/sticker-<?= $sticker->id . '/' . $num ?>.png);"></span>
                                                </div>
                                                <div class="sticker__imgPreview detailView__stickerList_previewImage nonDisp">
                                                    <span class="sticker__image detailView__stickerList_preview" style="background-image:url(./img/sticker-<?= $sticker->id . '/' . $num ?>.png);">
                                                    </span>
                                                </div>
                                            </li>
                                        <?php } ?>
                            ...
                            <ul class="section__noteList">
                                ...
                                <li class="section__noteList_item">
                                    ...
                                    <div class="noteList__item">
                                        <div class="noteList__item_detailList">
                                            ...
                                            <p class="noteList__item_detail">
                                                ．<span>左側為已註冊清單，如未登入無法瀏覽。</span>
                                            </p>
                                            <p class="noteList__item_detail">
                                                ．<span>右上功能列，登入及登出功能，隨登入狀態改變。</span>
                                            </p>
                                        </div>
                                    </div>
                                </li>
                                <li class="section__noteList_item">
                                    ...
                                    <div class="noteList__item">
                                        <div class="noteList__item_detailList">
                                            <p class="noteList__item_detail">
                                                ．<span>依照網頁說明完成頁面功能。瀏覽已註冊清單及更改登出登入鍵</span>
                                            </p>
                                            <p class="noteList__item_detail">
                                                ．<span>註冊使用者需新增至資料庫，並讀取使用。</span>
                                            </p>
                                            <p class="noteList__item_detail">
                                                ．<span>資料庫設定沿用上週說明（新增web_class）。</span>
                                            </p>
                                        </div>
                                    </div>
                                </li>
